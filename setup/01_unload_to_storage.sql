...
CREATE STAGE IF NOT EXISTS  MASTERCLASS.PUBLIC.DATA_STAGE_AZURE
 ...
 URL = 'azure://<myaccount>.blob.core.windows.net/warehouse/lineitems/'
 COMMENT = 'Lineitems data stage Azure';

COPY INTO 'azure://<myaccount>.blob.core.windows.net/warehouse/lineitems/'
FROM (
...
LIST @MASTERCLASS.PUBLIC.DATA_STAGE_AZURE;